<?
	...
	$sql = "INSERT guest_user_t (guest_id, guest_pw, guest_name, company, telno, memo, reg_date)
			VALUES ('{$db_guest_id}', '{$db_guest_pw}', '{$db_guest_name}', '{$db_company}', '{$db_telno}', '{$db_memo}', NOW());";
