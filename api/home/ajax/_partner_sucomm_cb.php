...
/* ******************************************
	// callback base url : http://cb.aline-soft.kr/ajax-request.php?id=_partner_sucomm_cb
	// "http://cb.aline-soft.kr/ajax-request.php?id=_partner_sucomm_cb&appkey=ohcca56209ce2b04fc6e7288375b9f689bb&uniquekey=ohcuniquekey&userdata=" . base64_encode(json_encode(array('aid' => $userapp_id)))
**********************************************/
	...
	//## m_key
	$m_key 			= $_REQUEST['flexcode'];
	
	//## unique_key
	$unique_key 	= $g_sucom['unique_prefix'] . md5($_REQUEST['flexcode'] . $_REQUEST['ud']);
