<?
	...
	// test : $sql = "SELECT a.app_key, SUM(a.publisher_cnt) AS 'cnt', SUM(a.publisher_fee) AS 'fee', app.app_title AS 'name'
	$sql = "SELECT a.app_key, SUM(a.merchant_cnt) AS 'cnt', SUM(a.merchant_fee) AS 'fee', app.app_title AS 'name'
...
?>
	...
	<t4 style='line-height: 40px'>월간 앱별 매출 현황</t4>
	<hr>
	<div class='ui-grid-a'>
